...
@Component
public class GoogleIntegrationProvider implements IntegrationProvider {

    private final GoogleOAuthService googleOAuthService;
    private final OAuthIntegrationService oauthIntegrationService;

    public GoogleIntegrationProvider(
    ...
    public String buildAuthorizationUrl(Long userId) {
        ...
        String state = oauthIntegrationService.createState(userId, getProviderKey());
